...
1. Select **[!UICONTROL Activation]** from the menu ![Open the solution switcher using the icon and click Activation](assets/launch-create-a-property/web-launch-solutionSwitcherActivation.png)

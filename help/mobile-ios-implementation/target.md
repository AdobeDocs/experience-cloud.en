...
Open the sample page and paste it just before your Launch embed code as pictured below (don't worry if the line numbers are different):
   ![Hover over the extension](images/web-target-prehidingSnippet.png)
...
1. Click **[!UICONTROL Install]**
   ...
   ![Install the Target extension](images/web-target-installExtension.png)
...
1. Click **[!UICONTROL Save to Library and Build]** ![Save the extension](images/web-target-saveExtension.png)
...
1. Go to the **[!UICONTROL Rules]** in the top navigation and then click on `All Pages - Library Loaded` to open the rule editor
   ...
   ![Open All Pages - Library Loaded Rule](images/web-target-editRule.png)

1. Under Actions, click the ![Click the Plus icon](images/web-icon-plus.png) to add a new action

   ![Click the Plus icon to add a new action](images/web-target-addLoadTargetAction.png)
...
1. Click **[!UICONTROL Keep Changes]**
   ...
   ![Click Keep Changes](images/web-target-addLoadTargetAction-keepChanges.png)
...
1. Under Actions, click the ![Click the Plus icon](images/web-icon-plus.png) again to add another action

   ![Click the Plus icon to add another action](images/web-target-addGlobalMboxAction.png)
...
1. Click **[!UICONTROL Keep Changes]**
   ...
   ![Fire Global Mbox action](images/web-target-fireGlobalMbox.png)
...
1. Click **[!UICONTROL Save to Library and Build]**
   ...
   ![Fire Global Mbox action](images/web-target-fireGlobalMbox-saveAndBuild.png)
...
1. In the `Target` section, confirm that your client code, at.js library version, and your global mbox name appear
   ...
   ![Confirm that Target appears in the Summary tab of the Debugger ](images/web-target-summaryTab.png)

1. Finally, go to the `Target` tab, expand your client code, and confirm that the request for your global mbox appears:

   ![Confirm the global mbox request has been made](images/web-target-debugger-globalMbox.png)
...
1. Under Actions, click the ![Click the Plus icon](images/web-icon-plus.png) to add a new action
   ...
   ![Click the Plus icon to add a new action](images/web-target-addParamsAction.png)
...
1. Click the ![data element icon](images/web-icon-dataElement.png) to open the data element modal

   ![Click the data element icon to open the data element modal](images/web-target-addParamsActionOpenDataElement.png)

1. Click the `Page Name` data element

1. Click the **[!UICONTROL Select]** button

  ![Click the 'Select' button](images/web-target-mboxParam-pageName.png)

1. Click **[!UICONTROL Keep Changes]**

   ![Click Keep Changes](images/web-target-addPageName-keepChanges.png)
...
1. Click **[!UICONTROL Save to Library and Build]**
  ...
  ![Click Save to Library and Build](images/web-target-rearrangeActions.png)
...
![Click Keep Changes](images/web-target-debugger-pageName.png)
...
![Setting a profile parameter](images/web-target-profileParameter.png)
...
![Adding Entity Parameters](images/web-target-entityParameters.png)
...
![The Customer Id details should be visible as custom parameters in the mbox call](images/web-target-debugger-customerId.png)
...
1. Copy the `at_property` value to your clipboard
   ...
   ![Obtain the Property token from the Adobe Target interface](images/web-target-addATProperty-targetProperties.png)
...
1. Under Actions, click the `Adobe Target - Add Params to Global Mbox` action to open the `Action Configuration`
   ...
   ![Open the Add Params to Global Mbox action](images/web-target-openParamsAction.png)

1. Under the `pageName` parameter, click the **[!UICONTROL Add]** button

   ![Open the Add Params to Global Mbox action](images/web-target-addATProperty.png)

1. Name the parameter `at_property` and paste in the value you copied from the Target interface

1. Click **[!UICONTROL Keep Changes]**

   ![Click Keep Changes](images/web-target-addATProperty-keepChanges.png)

1. Click **[!UICONTROL Save to Library and Build]**
   ![Click Save and Build to Library](images/web-target-addATProperty-save.png)
...
![The Property Token should be visible as the at_property parameter in every global mbox request](images/web-target-debugger-atProperty.png)
...
1. Click **[!UICONTROL Conditions > Add]**
   ...
   1. Toggle on the Regex option to change the logic from `equals` to `contains` (you can use the `Test` feature to confirm the test will pass with the URL `https://aem.enablementadobe.com/content/we-retail/us/en/user/checkout/order/thank-you.html`
      ...
      ![Enter dummy values for first name and last name](images/web-target-orderConfirm-test.png)
...
1. During the checkout process the only required fields are `First Name` and `Last Name`
   ...
   ![Enter dummy values for first name and last name](images/web-target-testOrderCart.png)
...
1. You should see the `orderConfirmPage` request as the latest Target request with the orderId, orderTotal, and productPurchasedId parameters populated with the details of your order
   ...
   ![orderConfirmPage mbox with required parameters](images/web-target-debugger-orderConfirmPage.png)
...
![Library Header and Footer in the Actions sequence](images/web-target-libraryHeaderFooter.png)

...
1. Click **[!UICONTROL Install]**
   ...
   ![Install the Analytics extension](images/web-analytics-catalog-install.png)
...
1. Under [!UICONTROL Library Management > Report Suites], enter the report suite ids you would like to use with each Launch environment (It's okay to use one report suite for all environments in this tutorial, but in real life you would want to use separate report suites, as shown in the image below)
   ...
   ![Enter the report suite ids](images/web-analytics-config-reportSuite.png)
...
1. Under [!UICONTROL General > Tracking Server], enter your tracking server, e.g. "`tmd.sc.omtrdc.net`." Enter your SSL Tracking Server if your site supports `https://`
   ...
   ![Enter the tracking servers](images/web-analytics-config-trackingServer.png)

1. In the [!UICONTROL Global Variables section], set the [!UICONTROL Page Name] variable using your `Page Name` data element. Click the ![data element icon](images/web-icon-dataElement.png) icon to open the modal and choose the page `Page Name` data element)

1. Click **[!UICONTROL Save to Library and Build]**

   ![Set the page name variable and save](images/web-analytics-extension-pageName.png)
...
1. Go to the **[!UICONTROL Rules]** section in the top navigation and then and then click **[!UICONTROL Add Rule]**
   ...
   ![Add Rule](images/web-target-addRule.png)

1. Name the rule `All Pages - DOM Ready`
1. Click **[!UICONTROL Events > Add]** to open the `Event Configuration` screen

   ![Name the rule and add the event](images/web-analytics-domReady-nameAddAnalyticsEvent.png)

1. Select **[!UICONTROL Event Type > DOM Ready]** (Note that the order of the rule is "50")
1. Click **[!UICONTROL Keep Changes]**
   ![Configure the Event](images/web-analytics-configureEventDomReady.png)

1. Under Actions, click the ![Click the Plus icon](images/web-icon-plus.png) to add a new action

   ![Click the Plus icon to add a new action](images/web-analytics-ruleAddAction.png)
...
1. Click the **[!UICONTROL Keep Changes]** button
   ...
   ![Click the Plus icon to add a new action](images/web-analytics-sendBeacon.png)

1. Click **[!UICONTROL Save to Library and Build]**

  ![Click Save to Library and Build](images/web-analytics-saveToLibraryAndBuild.png)
...
![Validate the page hit](images/web-analytics-validatePageHit.png)
...
1. Click **[!UICONTROL Save to Library and Build]**
   ...
   ![Add a new Data Element for Page Type](images/web-analytics-PageTypeDataElement.png)
...
1. Click **[!UICONTROL Save to Library and Build]**
   ...
   ![Add a new Data Element for Page Type](images/web-analytics-ProductIdDataElement.png)
...
1. Find the `Adobe Analytics Product String` extension by Adobe Consulting Services and click **[!UICONTROL Install]**
   ![Add the Adobe Analytics Product String extension by Adobe Consulting](images/web-analytics-addProductStringExtension.png)
1. Take a moment to read the instructions
1. Click **[!UICONTROL Save to Library and Build]**

   ![Save the extension and build it to your library](images/web-analytics-addProductStringExtensionSave.png)
...
1. Click **[!UICONTROL Events > Add]** to open the `Event Configuration` screen
   ...
   ![Name the rule and add the event](images/web-analytics-domReadyAddEvent.png)
...
1. Click **[!UICONTROL Keep Changes]**
   ![Configure the Event](images/web-analytics-configDOMReadyEvent.png)

1. Under **[!UICONTROL Conditions]**, click the ![Click the Plus icon](images/web-icon-plus.png) to open the `Condition Configuration` screen
   ![Click the Plus icon to add a new condition](images/web-analytics-PDPRuleAddCondition.png)
   ...
   1. Click **[!UICONTROL Keep Changes]**
      ...
      ![Define the condition](images/web-analytics-PDP-condition.png)

1. Under Actions, click the ![Click the Plus icon](images/web-icon-plus.png) to add a new action

   ![Click the Plus icon to add a new action](images/web-analytics-PDPAddAction.png)
...
1. Click **[!UICONTROL Keep Changes]**
      ...
      ![Set Analytics Variables in PDP Rule](images/web-analytics-PDPsetVariables.png)

1. Under Actions, click the ![Click the Plus icon](images/web-icon-plus.png) to add a new action

      ![Add another Action for the Product String](images/web-analytics-PDPaddProductStringAction.png)
...
1. Click **[!UICONTROL Keep Changes]**
      ...
      ![Add the Product String Variable using the Adobe Analytics Product String extension](images/web-analytics-PDPaddProductString.png)

1. Click **[!UICONTROL Save to Library and Build]**

      ![Save the rule](images/web-analytics-PDP-saveRule.png)
...
1. Click **[!UICONTROL Events > Add]** to open the `Event Configuration` screen
   ...
   ![Add New Arrivals Rule](images/web-analytics-newArrivalsRuleAdd.png)
...
![Configure the Enters Viewport Event](images/web-analytics-copyElementSelector.png)
...
1. Click **[!UICONTROL Keep Changes]**
   ![Configure the Enters Viewport Event](images/web-analytics-configEntersViewportEvent.png)
...
1. Click **[!UICONTROL Keep Changes]**
      ...
      ![Configure the Enters Viewport Event](images/web-analytics-configViewportAction.png)

1. Under Actions, click the ![Click the Plus icon](images/web-icon-plus.png) to add another new action

      ![Add Send Beacon Action](images/web-analytics-newArrivalsSendBeacon1.png)
...
1. Click **[!UICONTROL Keep Changes]**
      ...
      ![Config New Arrivals Beacon](images/web-analytics-configEntersViewportBeacon.png)
...
1. Click the **[!UICONTROL debugger icon]** ![Open the Experience Cloud Debugger](images/web-analytics-debuggerIcon.png) to open your [!UICONTROL Adobe Experience Cloud Debugger]
1. Click to the Analytics tab
...
1. Notice the normal page view hit for the home page with the page name, etc. (but nothing in eVar3 or prop3).
      ...
      ![Debugger with a Page View](images/web-analytics-debuggerPageView.png)
...
![Debugger with a Page View](images/web-analytics-debuggerEntersViewport.png)
...
1. In the Adobe Analytics extension, Click **[!UICONTROL Configure]**
      ...
      ![Configure Analytics](images/web-analytics-configureExtension.png)
...
![Add Plug-in Code](images/web-analytics-doPluginsAndGeValOnceCode.png)
...
This code will make sure that the same value is not sent in more than once in a row for 30 days (see the documentation for ways to customize this code to your needs).
      ...
      ![Call Plug-ins in doPlugins](images/web-analytics-doPluginsWithPlugins.png)
...
1. Leaving the Debugger open, go back to the We.Retail site and add  `?cid=1234` to the URL and hit Enter to refresh the page with that query string included
   ...
   ![Add a Query String](images/web-analytics-cidAdded.png)

1. Check the Debugger and confirm that there is a second Analytics request with a Campaign variable set to `1234`

      ![getQueryParam step 1](images/web-analytics-getQueryParam1.png)
...
1. Check the next hit in the Debugger, and the Campaign variable should not be present, because the getValOnce plug-in has made sure that it doesn't get duplicated and look like another person came in from the campaign tracking code.
   ...
   ![getQueryParam step 1](images/web-analytics-getQueryParam2.png)

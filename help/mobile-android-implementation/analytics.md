...
1. Having added your Lifecycle code in the previous section of the tutorial, build and run your project in Android Studio so that it launches the simulator

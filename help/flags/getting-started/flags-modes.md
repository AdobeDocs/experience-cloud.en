---
title: Flags modes
description: Learn about the two feature targeting modes in Flags — user-level targeting and org-level targeting — and when to use each.
hide: true
exl-id: 0fdfa429-d9bd-4990-8f96-cd9deb273aa0
---
# Flags modes {#modes}

Flags provides two distinct feature targeting modes. Each serves a different release control purpose and is designed for a specific type of application or use case.
